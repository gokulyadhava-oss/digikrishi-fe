...
export const EXPECTED_COLUMNS: {
  ...
  { key: "bank_name",      label: "Bank Name",      aliases: ["bank_name", "bankName", "Bank Name"],      required: false, group: "Bank" },
  { key: "ifsc_code",      label: "IFSC Code",      aliases: ["ifsc_code", "ifscCode", "IFSC Code"],      required: false, group: "Bank" },
  { key: "account_number", label: "Account Number", aliases: ["account_number", "accountNumber", "Account Number"], required: false, group: "Bank" },
...
const GROUPS = ["Core", "Address", "Bank", "Profile", "Documents"] as const;
...
export function CsvValidationModal({
  ...
  const { matches, unknowns, missingRequired } = analyzeColumns(csvHeaders);
